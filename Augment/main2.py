...
class Channel2:
    def __init__(self, id, pos_samples, neg_samples) -> None:
        ...
        self.model = LSTM0(input_size=1, hidden_size=128, num_layers=2, num_classes=1)
...
def main(file_no):
    ...
    channel = Channel2(file_no, train_pos_list, train_neg_data)
    channel.train()
