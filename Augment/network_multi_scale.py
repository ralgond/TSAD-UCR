...
class MSResNet(nn.Module):
    def __init__(self, input_channel, layers=[1, 1, 1, 1], num_classes=1):
        self.inplanes3 = 64
        self.inplanes5 = 64
        self.inplanes7 = 64
        ...
        self.maxpool5 = nn.AvgPool1d(kernel_size=4, stride=1, padding=0)
        ...
        self.maxpool7 = nn.AvgPool1d(kernel_size=2, stride=1, padding=0)
