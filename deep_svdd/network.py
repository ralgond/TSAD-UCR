...
class AE_Conv_192(nn.Module):
    def __init__(self) -> None:
        ...
        self.encoder = nn.Sequential(
            ...
            Flatten(),
            #Print("A"),
            nn.Linear(192, 32, bias=False), # compress into a (32,) vector
            #Print("B"),
        )
        self.encoder.__setattr__("rep_dim", 32)
        ...
        self.decoder = nn.Sequential(
            ...
            Interpolation(3),
            nn.ConvTranspose1d(8, 16, 5, padding=2, bias=False),
            nn.ReLU(),
            
            Interpolation(4),
            nn.ConvTranspose1d(16, 1, 5, padding=2, bias=False),
